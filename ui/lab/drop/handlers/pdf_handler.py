...
class PdfDropHandler:
    """Handler for PDF file drop operations onto the spatial Lab canvas.

    Converts local PDF reference paths into PDF Reference Node dictionaries
    without copying, moving, or duplicating the original asset files.
    """
